        ...
        <div className="mb-6">
          ...
          <div className="relative">
            <Listbox value={statusFilter} onChange={setStatusFilter}>
              <ListboxButton className="relative w-full rounded-xl border border-zinc-200 bg-white px-4 py-3 text-left shadow-sm focus:outline-none focus:ring-2 focus:ring-amber-500">
        ...
        {appointment.status === 'scheduled' && (
          <div className="mt-2 flex flex-wrap gap-2">
            ...
            <button
              ...
              disabled={isUpdating}
              className="rounded-lg bg-zinc-200 px-3 py-1.5 text-xs font-medium text-zinc-700 hover:bg-zinc-300 disabled:opacity-60"
            >
              Cancelar
            </button>
          </div>
